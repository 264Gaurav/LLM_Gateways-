<!-- ## qwen-3 embedding model is downloaded (with high vector dimention - 1048)
## use that instead of nomic-embed (768 - dimenstion ) which is low and causing cache collision e.g., 
### What is DRY Principle?
### What is SOLID Principle?  -->

-- Because their cosine similarity is high (1) i.e., difference in score =0.000
